  ...
  return (
        <div className="flex flex-row items-center justify-between rounded-lg border border-gray-300 px-6 py-6">
              <div className="flex mr-4">
                <span className="items-center px-4 py-4 m-auto bg-red-200 rounded-full hover:bg-red-300">
                  <svg xmlns="http://www.w3.org/2000/svg"
                       className="items-center w-8 h-8 m-auto text-red-500 hover:text-red-600" fill="none"
              ...
              <div className="flex-1 pl-1">
                  <div className="text-2xl font-medium text-gray-600">{addSpacesToNumber(economieParAns)} DH / Mois
                  </div>
                  <div className="text-sm text-gray-400 sm:text-base">
                      Économies sur les frais au bout {" "}
